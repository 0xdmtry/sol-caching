use crate::{
    service::confirmation_service::{
        ConfirmationStatus, check_slot_confirmation_with_lru_and_circuit_breaker,
    },
    state::AppState,
};
use axum::{
...
pub async fn check_slot_confirmation_handler(
    ...
    match check_slot_confirmation_with_lru_and_circuit_breaker(&app_state, slot).await {
